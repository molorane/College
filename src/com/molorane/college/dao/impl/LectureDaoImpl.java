...
import com.molorane.college.dao.LectureDao;
import com.molorane.college.dao.ModuleDao;
import com.molorane.college.dao.TermDao;
...
public class LectureDaoImpl extends LectureDao{
    ...
    public ArrayList<Term> GetLectureTermsInCampus(int lectureId, int campusCode) {
        try {
            ...
            Functions.errorMessage("GetLectureTermsInCampus error: "+ e.getLocalizedMessage());
        }
        return null;
    }
